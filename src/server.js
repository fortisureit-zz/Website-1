...
app.use(csp({
    policies: {
        ...
        'img-src': [csp.SELF, csp.INLINE, 'https://fonts.googleapis.com/', `https://res.cloudinary.com/dxleu7n2q/image/upload/v1582555372/fortisure-it-site/home-head-office_rxchsb.jpg`],
