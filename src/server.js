...
app.use(
  csp({
    policies: {
      ...
      'script-src': [csp.SELF, csp.INLINE, csp.NONCE, 'EDNnf03nceIOfn39fn3e9h3sdfa' 'https://www.google.com/recaptcha/', "https://www.gstatic.com/recaptcha/", 'https://www.google.com/recaptcha/api.js'],
      'worker-src': [csp.NONE],
